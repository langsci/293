...
\ex 
\gll {\textbf{ʔɨt-a}} səbyti kɨ-t-məs'ɨʔ ʔalləw-{\textbf{wwa}} \\
...
\gll  {\textbf{\textcrh ant-i}} səbyti sələstə ʔə\textcrh wat ʔalləw-u-{\textbf{wwa}}  \\
...
\gll  {\textbf{\textcrh ant-i}} səbyti kɨ-t-məs'ɨʔ ʔalləww-{\textbf{wa}} \\
       one-{\scshape fsg} woman {\scshape fut-3fsg.s}.come{\scshape impf} {\scshape have-3fsg.o}\\
...
\gll \textit{Selam} lomaʕanti kɨ-t-mə-s'ʔ ʔalləw-wa\\
...
\gll lomaʕanti kɨ-t-mə-s'ʔ \textit{Selam} ʔalləw-wa\\
...
\gll (*{\textbf{nɨ}}-)\textit{Selam} kɨ-t-mə-s'ʔ ʔalləw-wa\\
...
\glt Intended: `Yared has many friends.'}
\ex[]{ 
\gll \textit{Selam} (*{\textbf{nɨ}}-)kɨ-t-mə-s'ʔ ʔalləw-wa\\
...
\gll   lomaʕanti kɨ-t-mə-s'ʔ {\textbf{nɨʕaʕa}} ʔalləw-wa\\
...
\ex[*]{%
\gll nɨssa k'əlt'ifa kɨ-t-mə-s'ʔ (bɨ-Selam) {\textbf{tə}}-nəyr-u(-wa)\\
...
daughter-his to-house-education {\scshape neg-nml-}go-{\scshape 3fsg.poss} annoy.{\scshape pf-3msg.s(-3msg.o)}\\
 \glt `That his daughter didn't go to school annoyed him.'}
 \ex[]{
 \gll  \textit{tɨħti}-\textit{fɨraʃ} t'ɨrə gənzəb yɨ-ħɨbəʔəll-u-(*{\textbf{wwo}})\\
       under-mattress raw money {\scshape 3msg}-hide.{\scshape impf-3msg.s(-3msg.o)}\\
